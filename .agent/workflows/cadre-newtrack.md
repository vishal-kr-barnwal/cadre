...
Create a new track for: the input provided with this command (the text typed after the command name)
...
2. **Get Track Description:**
   - **If `the input provided with this command (the text typed after the command name)` provided:** Use it as track description
   - **If empty:** Ask:
