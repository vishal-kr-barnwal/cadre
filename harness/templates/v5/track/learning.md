...
Record every applicable pattern as {"path":"patterns/<slug>.md","sha256":"<SHA-256 of exact approved bytes>"} in the patterns array. Keep the human-readable relevance and constraints below synchronized. An empty array means no existing pattern applies, never missing research.
