...
- Candidate apply validates approved Cadre manifests and promotes state/indexes together. It cannot edit arbitrary product files or execute Git. Migration requires one approved refresh at a quiescent boundary; preserve historical evidence and immutable v1–v4 templates.
