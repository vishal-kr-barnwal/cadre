...
5. Call `template_get_many` for `project/refresh`, retain the versioned result, and render `refreshes/refresh-<ts>.md` with evidence range, decisions, affected files, and unresolved questions. Present all artifacts and diffs for approval.
