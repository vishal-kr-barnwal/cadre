...
4. Assess impact on all active track specs, plans, and marked Pattern Seed sections in learning files. Route required track changes through the same cascading approval rules as `$cadre-revise`. Ask if a material impact remains uncertain after inspection.
