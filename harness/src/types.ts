...
export interface RuntimeArgs extends JsonObject {
  ...
  proposedContext?: JsonObject;
  proposed_context?: JsonObject;
  detectedChanges?: JsonValue[] | JsonObject | string;
  detected_changes?: JsonValue[] | JsonObject | string;
  refreshLevels?: string[] | string;
  refresh_levels?: string[] | string;
  refreshScope?: string[] | string;
  refresh_scope?: string[] | string;
  scope?: string;
  scopes?: string[];
  patterns?: JsonObject | JsonValue[] | boolean;
  docs?: boolean;
  projections?: boolean;
  diagnostics?: boolean;
  repositoryTopology?: JsonObject;
  repository_topology?: JsonObject;
  plan?: JsonObject;
  spec?: JsonObject;
  techStack?: JsonObject;
  approvalStage?: string;
  approval_stage?: string;
  approvalStageHash?: string;
  approval_stage_hash?: string;
  approvalStageRevision?: number;
  approval_stage_revision?: number;
  ...
  agentIdentifier?: "claude" | "codex" | "copilot" | "antigravity";
  epicId?: string;
  assignee?: string;
  taskId?: string | null;
