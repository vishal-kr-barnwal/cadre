...
export const TOOLS = [
  ...
  packetSchema({
    ...
    fields: ["workflow", "action", "id", "formulaId", "variables", "wispId", "stepId", "stepIndex", "execute", "humanConfirmed", "trackId", "detail", "providerMode", "providerEvidence", "mcpCapabilities", "product", "productGuidelines", "workflowPolicy", "techStack", "spec", "plan", "description", "artifact", "scope", "status", "summary", "evidence", "config", "configurationId", "configuration", "breakpoints", "files", "testCommand", "async", "timeoutMs"],
    required: ["root"],
