...
const RESOURCE_DEFINITIONS: ResourceDefinition[] = [
  ...
  { uri: "cadre://dap-status", name: "Cadre DAP status", description: "Configured DAP adapters plus setup recommendations. Read with ?root=/path." },
...
const RESOURCE_CONTRACTS: Record<string, ResourceContract> = {
  ...
  "cadre://dap-status": { required: ["root"] },
