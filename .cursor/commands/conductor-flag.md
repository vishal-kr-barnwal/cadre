...
Flag a task's status: the input provided with this command (the text typed after the command name)
...
Parse `the input provided with this command (the text typed after the command name)` for the mode:
