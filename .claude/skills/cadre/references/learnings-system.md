...
### Project-Level: `cadre/patterns.md`
...
### Per-Track: `cadre/tracks/<track_id>/learnings.md`
...
1. **At Start:**
   ...
   - Read `cadre/tracks/<id>/learnings.md`
...
4. Update `cadre/patterns.md` with merged patterns

## Templates

Templates are bundled in the skill's `references/` folder:
- [patterns-template.md](patterns-template.md) - Full template for `cadre/patterns.md`
